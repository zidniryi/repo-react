					...
					<div class="col-lg-9">
						<div class="card mt-4">
							<img
								...
								src={require('../../assets/sub/OFM_-_equalizer_bar.png')}
								alt=""
							/>
							<div class="card-body">
								<h3 class="card-title">Equalizer Bar </h3>
								<p>
									Equalizer Bar by Berco are designed and manufactured for long
						...
						<div class="card card-outline-secondary my-4">
							...
							<div class="card-body">
								<iframe
									width="100%"
									height="600px"
									src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRsXNzlrb9RIhw0CR0aS8lxjJ2Gd6lwwQip373PjZyZ44ZizlaXDq7H5Mciu6PRSg/pubhtml?widget=true&amp;headers=false"
								></iframe>
							</div>
						</div>
						{/* <!-- /.card --> */}
